    ...
    <div className="flex items-center justify-center px-4 py-20 min-h-screen">
      <div className="w-full max-w-[420px] bg-white rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.07)] border border-gray-100 p-8">
        ...
        <button
          ...
          type="button"
          disabled={!isLoaded}
          className="w-full h-10 border border-gray-200 rounded-lg text-[#1F2B2D] flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
