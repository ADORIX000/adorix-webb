                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-400 text-sm">
                            ...
                            <li><Link to="/settings/help" className="hover:text-adorix-primary transition-colors">API Docs</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-400 text-sm">
                            ...
                            <li><Link to="/contact" className="hover:text-adorix-primary transition-colors">Careers</Link></li>
                            <li><Link to="/" className="hover:text-adorix-primary transition-colors">Blog</Link></li>
                        </ul>
                    </div>
