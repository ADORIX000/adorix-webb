                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                      ...
                      <div className="space-y-2">
                        <Link href="/dashboard/studio" className="block p-3 rounded-lg hover:bg-gray-50 text-gray-700 font-medium transition-colors">
                          Create Campaign
                        </Link>
                        <Link href="/dashboard" className="block p-3 rounded-lg hover:bg-gray-50 text-gray-700 font-medium transition-colors">
                          View Analytics
                        </Link>
                        <Link href="/payment-method" className="block p-3 rounded-lg hover:bg-gray-50 text-gray-700 font-medium transition-colors">
                          Manage Billing
                        </Link>
                      </div>
                    </div>
              ...
              <div className="space-y-6">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                  ...
                  <div className="flex items-center justify-between p-6 bg-gradient-to-r from-adorix-light to-white rounded-xl border border-adorix-primary/20">
                    ...
                    <Link href="/pricing" className="px-6 py-3 bg-adorix-dark hover:bg-adorix-primary text-white rounded-xl font-bold transition-colors">
                      Upgrade Plan
                    </Link>
                  </div>
                </div>
